...
public class PasswordGestureView extends View {
    ...
    public PasswordGestureView(Context context) {

        this(context, null);
    }

    public PasswordGestureView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PasswordGestureView(Context context, AttributeSet attrs, int defStyleAttr) {
