...
public class SimplifyTextView extends android.support.v7.widget.AppCompatTextView{
     ...
     */
    public SimplifyTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public SimplifyTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            info.setClassName(SimplifyTextView.class.getName());
        }
    }
